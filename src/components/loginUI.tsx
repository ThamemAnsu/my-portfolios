...
export function GenerativeArtScene() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      geometry = new THREE.IcosahedronGeometry(1.2, 64);
  ...
  if (!webglSupported) {
    return (
      <div className="absolute inset-0 w-full h-full z-0 overflow-hidden flex items-center justify-center bg-gradient-to-br from-red-500/5 via-transparent to-red-600/5">
        <div className="w-[50vw] h-[50vw] max-w-[400px] max-h-[400px] rounded-full bg-red-500/10 blur-[80px] animate-pulse" />
      </div>
    );
  }
